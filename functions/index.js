/* eslint-disable */
// =========================================================================================
// == GCP Cloud Function 完整程式碼 (v1.5.6 - 語法重構與穩定版)
// =========================================================================================
...
const d1Client = {
  ...
  /**
   * 執行批次 SQL 操作
   * @param {Array<Object>} statements - 陳述式陣列，每個物件包含 { sql, params }
   * @returns {Promise<Array<Object>>} 操作結果
   */
