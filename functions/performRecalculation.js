...
async function performRecalculation(uid, modifiedTxDate = null, createSnapshot = false) {
    ...
    try {
        ...
        // 6. 【然後】從準備好的資料庫中，一次性讀取所有市場數據到記憶體
        ...
        // 9. 增量計算每日資產價值 (使用 State Calculator)
        ...
        // 10. 計算各項核心指標 (使用 Metrics Calculator)
