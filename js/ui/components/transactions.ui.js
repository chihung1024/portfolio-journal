// =========================================================================================
// == 交易紀錄 UI 模組 (transactions.ui.js) v4.0 - Selector-Driven
// =========================================================================================
...
export async function renderTransactionsTable() {
    const { transactionFilter, transactionsPerPage, transactionsCurrentPage } = getState();
    const container = document.getElementById('transactions-tab');

    // 【核心修改】直接從 selector 獲取合併後的數據，不再需要手動處理暫存區
