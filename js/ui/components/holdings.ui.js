// =========================================================================================
// == 持股表格 UI 模組 (holdings.ui.js) - v_mobile_list (支援行動端緊湊列表模式)
// =========================================================================================
    ...
    return `
        <div class="grid grid-cols-2 gap-x-4 gap-y-3 text-sm p-4 bg-gray-50">
            ...
            <div class="col-span-2 flex justify-end">
                 <button class="open-notes-btn btn text-xs bg-white border border-gray-300 rounded-md px-2 py-1 flex items-center space-x-1 text-gray-600 hover:bg-gray-100" data-symbol="${h.symbol}">
...
export function renderHoldingsTable(currentHoldings) {
    ...
    // --- 【修改】最終渲染邏輯 ---
    // 組合 HTML，並根據 mobileViewMode 決定顯示 card 還是 list
    const mobileContent = `
