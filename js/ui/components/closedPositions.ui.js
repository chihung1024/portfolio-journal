...
export function renderClosedPositionsTable() {
    ...
    const tableHeader = `
        <thead class="bg-gray-50">
            <tr>
                <th class="w-12 px-3 py-3 text-left text-xs font-medium text-gray-500"></th>
                <th class="px-4 py-3 text-left text-sm font-medium text-gray-600 tracking-wider">代碼</th>
                <th class="px-4 py-3 text-right text-sm font-medium text-gray-600 tracking-wider">總已實現損益 (TWD)</th>
                <th class="px-4 py-3 text-right text-sm font-medium text-gray-600 tracking-wider">報酬率</th>
            </tr>
        </thead>`;
